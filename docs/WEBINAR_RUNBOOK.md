...
4. Bug report : lien `!` / « Signale un bug » dans le footer (visible aussi en webi) → modale. Meta `bug-report-endpoint` vide = « Signalement temporairement indisponible ». Voir `docs/BUG_REPORTS.md`.
