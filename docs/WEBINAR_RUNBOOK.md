...
4. Bug report : lien `!` / « Signale un bug » dans le footer (visible aussi en webi) → modale. Meta `bug-report-token` vide = « Signalement temporairement indisponible ». Voir `docs/BUG_REPORTS.md`.
